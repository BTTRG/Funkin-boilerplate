				...
				default:
					{
						...
						case 'yourstage':
							{
								defaultCamZoom = 0.9;
								curStage = 'your-stage-here';

								// This is YOUR custom stage code.
								/* Make sure your stage graphic is is assets/shared/images
								you can also put the stage images in a folder

								example: var stage:FlxSprite = new FlxSprite(-650, 600).loadGraphic(Paths.image('yourfolder/yourimage'));

								yeah to change the zoom change defaultCamZoom, to change ur background's position change the (-650, 600) part of the code
								uhh also u can make a background element move more or less by using scrollFactor.set
								u can do a parallax effect with this
								*/
